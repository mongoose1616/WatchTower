...
- `watchtower doctor`, `watchtower status`, `watchtower init`, `watchtower work start`, `watchtower work begin`, `watchtower work list`, `watchtower work next`, `watchtower work show`, `watchtower work note`, and `watchtower work complete` CLI commands
